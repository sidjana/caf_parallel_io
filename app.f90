	...
	program compatibility_test
	   ...
	   if (rank == 1) then
	   call caf_file_read_str(10, (/2,2,1/), (/2,3,3/), (/1,1,2/), buff, rank,4)
	   !call caf_file_read(10, (/2,2/), (/3,3/), buff, rank, 4)

	   else if(rank == 2 ) then
	   call caf_file_read_str(10, (/1,1,1/), (/3,3,3/), (/2,2,2/), buff, rank, 8)
	   ...
	   call caf_file_read_str(10, (/2,3,1/), (/3,3,3/), (/1,1,1/), buff, rank, 6)
